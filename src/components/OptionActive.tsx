    ...
    export default function Option_active(){
        return(
        <div className="flex flex-col justify-center md:hidden ">  
            ...
            <div className="flex flex-row overflow-x-auto w-full max-w-[400px] "> {/* Thiết lập chiều rộng tối đa */}
                <Link href="/activity"><button className="bg-black text-white whitespace-nowrap text-sm font-bold ml-2 border border-1 border-solid rounded-lg py-1 px-7">Tất cả</button></Link>
